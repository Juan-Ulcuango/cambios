...
<div class="form-group mb-3">
    ...
    <div>
        ...
        <small class="form-hint">empleado <b>empleado_id</b> instruction.</small>
    </div>
</div>
<div class="form-group mb-3">
    ...
    <div>
        ...
        <small class="form-hint">empleado <b>nombre_empleado</b> instruction.</small>
    </div>
</div>
<div class="form-group mb-3">
    ...
    <div>
        ...
        <small class="form-hint">empleado <b>apellido_empleado</b> instruction.</small>
    </div>
</div>
<div class="form-group mb-3">
    ...
    <div>
        ...
        <small class="form-hint">empleado <b>email_empleado</b> instruction.</small>
    </div>
</div>
<div class="form-group mb-3">
    ...
    <div>
        ...
        <small class="form-hint">empleado <b>direccion_empleado</b> instruction.</small>
    </div>
</div>
<div class="form-group mb-3">
    ...
    <div>
        ...
        <small class="form-hint">empleado <b>telefono_empleado</b> instruction.</small>
    </div>
</div>
<div class="form-group mb-3">
    ...
    <div>
        ...
        <small class="form-hint">empleado <b>rol</b> instruction.</small>
    </div>
</div>
    ...
    <div class="form-footer">
        <div class="text-end">
            <div class="d-flex">
                <a href="{{ route('empleados.index') }}" class="btn btn-danger">Cancel</a>
