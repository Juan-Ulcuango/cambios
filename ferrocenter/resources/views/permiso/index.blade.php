        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-12 col-md-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('permisos.create') }}" class="btn btn-primary d-none d-sm-inline-block">
                ...
                <div class="col-12">
                    <div class="card">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a class="dropdown-item"
                                                           href="{{ route('permisos.show',$permiso->id) }}">
                                                            View
                                                        </a>
                                                        <a class="dropdown-item"
                       ...
                       <div class="card-footer d-flex align-items-center">
                            {!! $permisos->links('tablar::pagination') !!}
                        </div>
                    </div>
                </div>
            </div>
